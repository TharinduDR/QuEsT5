...
from examples.sentence_level.wmt_2020.si_en.quest5_config import quest5_config, MODEL_TYPE, MODEL_NAME, SEED, \
...
draw_scatterplot(dev, 'z_mean', 'predictions', os.path.join(TEMP_DIRECTORY, RESULT_IMAGE), "Sinhala-English-Dev")
...
draw_scatterplot(test, 'z_mean', 'predictions', os.path.join(TEMP_DIRECTORY, RESULT_IMAGE), "Sinhala-English-Test")
